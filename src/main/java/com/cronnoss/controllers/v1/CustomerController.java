...
import com.cronnoss.api.v1.model.CustomerListDTO;
import com.cronnoss.services.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerListDTO> getAllCustomers() {
        ...
        return new ResponseEntity<CustomerListDTO>(
                new CustomerListDTO(customerService.getAllCustomers()), HttpStatus
                .OK);
    }
